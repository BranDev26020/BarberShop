<form action="<?php echo "/authenticate_user?id=".$id.""?>" class="formulario" method="post">
    <p class="formulario__bienvenida">Restore your access password.</p>
    <p class="formulario__descripcion">We have sent you the instructions to restore your account to your email address.</p>
